...
export default function Nosotros() {
  return (
    <>
      ...
      <section style={{
        ...
        <div className="page-hero-content" style={{ position: 'relative', maxWidth: 1200, width: '100%', margin: '0 auto', padding: '80px 40px 64px' }}>
          ...
          <h1 style={{
            ...
            SOBRE<br /><span style={{ color: '#E85D04' }}>NOSOTROS</span>
          </h1>
        </div>
      </section>
        ...
        <div className="nos-historia-grid" style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 80, alignItems: 'start' }}>
          <div>
            ...
            <h2 className="heading-lg" style={{ marginBottom: 16, fontSize: 'clamp(32px,4vw,52px)' }}>
              65+ AÑOS<br />
              <span style={{ color: '#E85D04' }}>DE EXPERIENCIA</span>
            </h2>
            <div className="accent-line"/>
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 16.875, color: '#3A3A3A', lineHeight: 1.8, marginBottom: 20 }}>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: 16.875, color: '#3A3A3A', lineHeight: 1.8, marginBottom: 32 }}>
            ...
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              {[
                ...
                <div key={i} style={{ textAlign: 'center' }}>
                  <div style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 40, color: '#E85D04', lineHeight: 1 }}>{s.value}</div>
                  <div style={{ fontFamily: 'var(--font-display)', fontSize: 11, letterSpacing: '2px', textTransform: 'uppercase', color: '#8D9BAB', marginTop: 4 }}>{s.label}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="nos-mision-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64 }}>
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(28px,3.5vw,44px)', textTransform: 'uppercase', color: '#fff', lineHeight: 1.1, marginBottom: 20 }}>
                EN TODO ESTE TIEMPO DE PERMANENCIA<br /><span style={{ color: '#E85D04' }}>EN EL MERCADO NACIONAL</span>
              </h2>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 16.875, color: '#8D9BAB', lineHeight: 1.8 }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 16.875, color: '#8D9BAB', lineHeight: 1.8, marginTop: 16 }}>
                ...
                país: <strong style={{ color: '#C8CDD3' }}>minera, forestal, pesquería, agricultura e industria en general.</strong>
              </p>
            </div>
            <div>
              <p className="label" style={{ marginBottom: 12 }}>Manufactura</p>
              <h2 style={{ fontFamily: 'var(--font-display)', fontWeight: 900, fontSize: 'clamp(28px,3.5vw,44px)', textTransform: 'uppercase', color: '#fff', lineHeight: 1.1, marginBottom: 20 }}>
                ESTÁNDARES<br /><span style={{ color: '#E85D04' }}>INTERNACIONALES</span>
              </h2>
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 16.875, color: '#8D9BAB', lineHeight: 1.8 }}>
              ...
              <p style={{ fontFamily: 'var(--font-body)', fontSize: 16.875, color: '#8D9BAB', lineHeight: 1.8, marginTop: 16 }}>
                ...
                como en el hogar. Para este propósito contamos con una <strong style={{ color: '#C8CDD3' }}>flota de vehículos y técnicos
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 2 }}>
            {valores.map((v, i) => (
              ...
              onMouseEnter={e => {
                ...
                if (desc) desc.style.color = '#8D9BAB'
              }}
              onMouseLeave={e => {
                const el = e.currentTarget as HTMLDivElement
              ...
              >
                ...
                <p className="val-title" style={{
                  ...
                  textTransform: 'uppercase', color: '#111', marginBottom: 12,
                  transition: 'color 0.2s',
                }}>{v.title}</p>
                <p className="val-desc" style={{
                  fontFamily: 'var(--font-body)', fontSize: 15.75, color: '#666',
      ...
      {/* Contact strip */}
      <section style={{ background: '#F0EEE9', padding: '56px 0', borderTop: '1px solid #ddd' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          <p style={{ fontFamily: 'var(--font-body)', fontSize: 18, color: '#3A3A3A', marginBottom: 24 }}>
