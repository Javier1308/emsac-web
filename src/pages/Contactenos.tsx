      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px' }}>
          ...
          <h1 style={{
            ...
            CONTÁC-<br /><span style={{ color: '#E85D04' }}>TENOS</span>
          </h1>
      ...
      <section className="section" style={{ background: '#F0EEE9' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 40px', display: 'grid', gridTemplateColumns: '1.4fr 1fr', gap: 64 }}>
          ...
          <div>
            ...
            {sent ? (
              <div style={{
                background: '#111', border: '1px solid rgba(232,93,4,0.4)', borderLeft: '4px solid #E85D04',
              ...
              <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        background: '#fff', border: '1.5px solid #C8CDD3',
                        borderRadius: 2, fontFamily: 'var(--font-body)', fontSize: 15.75, color: '#111',
                        outline: 'none', transition: 'border-color 0.2s',
                      }}
                      onFocus={e => (e.currentTarget as HTMLInputElement).style.borderColor = '#E85D04'}
                      onBlur={e => (e.currentTarget as HTMLInputElement).style.borderColor = '#C8CDD3'}
                    />
                  </div>
                  <div>
                    <label style={{ fontFamily: 'var(--font-display)', fontSize: 11, letterSpacing: '3px', textTransform: 'uppercase', color: '#8D9BAB', display: 'block', marginBottom: 8 }}>
                      Empresa
                    </label>
                    <input
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onFocus={e => (e.currentTarget as HTMLTextAreaElement).style.borderColor = '#E85D04'}
                    onBlur={e => (e.currentTarget as HTMLTextAreaElement).style.borderColor = '#C8CDD3'}
                  />
                </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
              {contactInfo.map((c, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ color: '#E85D04', marginTop: 2, flexShrink: 0 }}>{c.icon}</div>
                  <div>
                    <p style={{ fontFamily: 'var(--font-display)', fontSize: 10, letterSpacing: '3px', textTransform: 'uppercase', color: '#E85D04', marginBottom: 6 }}>{c.label}</p>
                    <p style={{ fontFamily: 'var(--font-body)', fontSize: 15.75, color: '#C8CDD3', lineHeight: 1.7, whiteSpace: 'pre-line' }}>{c.value}</p>
                  </div>
                </div>
              ))}
            </div>
